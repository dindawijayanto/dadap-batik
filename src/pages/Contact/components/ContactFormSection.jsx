      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        <div className="flex flex-col gap-8 h-full justify-between">
          ...
          <div className="bg-[#FFEAD7] p-8 md:p-10 rounded-sm flex flex-col gap-5 shadow-sm">
            ...
            <a href="https://www.instagram.com/dadapbatikbatu?igsh=ZmUwNjRrMnZkMjM1&utm_source=qr" target="_blank" rel="noreferrer" className="flex items-center justify-between bg-white px-5 py-4 rounded-sm border border-transparent hover:border-[#B5914A] transition-all group shadow-sm">
            ...
            <a href="https://www.tiktok.com/@dadapbatikbatu?_r=1&_t=ZS-96aghJ3R2wy" target="_blank" rel="noreferrer" className="flex items-center justify-between bg-white px-5 py-4 rounded-sm border border-transparent hover:border-[#B5914A] transition-all group shadow-sm">
