  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-6 bg-black/60 backdrop-blur-sm transition-opacity">
      ...
      <div className="bg-[#FFFBF7] w-full max-w-4xl max-h-[90vh] rounded-xl shadow-2xl overflow-hidden flex flex-col md:flex-row relative animate-fade-in-up">
        ...
        <div className="w-full md:w-1/2 p-5 md:p-10 flex flex-col flex-1 min-h-0">
          <div className="flex flex-row md:flex-col items-center justify-between md:items-start gap-4 mb-4">
            <h2 className="text-lg md:text-3xl font-serif text-[#4D342D] mb-2">
              {product.title}
            </h2>
            <p className="text-[#A88877] font-bold text-sm mb-2">
          ...
          <div className="grid grid-cols-2 gap-6 mb-8 pb-6 border-b border-[#EAE4DF]">
            <div>
              <span className="text-[10px] font-bold text-[#8C7A71] uppercase tracking-widest block mb-1">
                Ukuran Kain
              </span>
              <span className="text-sm text-[#4D342D] font-medium">
                {product.dimension}
              </span>
            </div>
            <div>
          ...
          {/* Tab Content Area */}
          <div className="flex-1 min-h-0 overflow-y-auto text-sm text-[#5C4D46] leading-relaxed mb-6 pr-2">
              ...
              <div className="animate-fade-in flex flex-col gap-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center gap-3 border border-[#EAE4DF] p-3 rounded-sm">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-[#4D342D]">
                      Dry Clean Only
                    </span>
                  </div>
                  <div className="flex items-center gap-3 border border-[#EAE4DF] p-3 rounded-sm">
          ...
          {/* Routing CTA */}
          <div className="mt-auto pt-4 border-t border-[#EAE4DF] bg-[#FFFBF7] shrink-0">
            <Link
