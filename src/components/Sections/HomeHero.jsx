  ...
  return (
    <section className="relative h-screen flex justify-center items-center pt-32 pb-24 px-6 md:px-16 lg:px-24 bg-[#FAF6F2]">
      ...
      <div className="flex flex-col items-center text-center gap-2 max-w-3xl mx-auto">
        <h4 className="text-xs font-semibold text-[#B2993D] tracking-[3px] uppercase">
          Warisan Pengrajin sejak 2019
        </h4>
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#001020] leading-[1.1] font-serif">
          Merangkai
          <br /> Warisan dalam
          <br /> Setiap Helai Batik
        </h1>
        <p className="text-base text-[#5C4D46] leading-relaxed max-w-lg">
